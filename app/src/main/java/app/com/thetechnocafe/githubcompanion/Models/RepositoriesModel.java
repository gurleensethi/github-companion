...
public class RepositoriesModel implements Parcelable {
    ...
    public final static Parcelable.Creator<RepositoriesModel> CREATOR = new Creator<RepositoriesModel>() {
        ...
        public RepositoriesModel createFromParcel(Parcel in) {
            RepositoriesModel instance = new RepositoriesModel();
            ...
            instance.networkCount = ((Integer) in.readValue((Integer.class.getClassLoader())));
            instance.subscribersCount = ((Integer) in.readValue((Integer.class.getClassLoader())));
            return instance;
        }
