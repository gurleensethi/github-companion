...
public class UsersSearchModel implements Parcelable {
    ...
    public final static Parcelable.Creator<UsersSearchModel> CREATOR = new Creator<UsersSearchModel>() {


        @SuppressWarnings({
                "unchecked"
        })
        public UsersSearchModel createFromParcel(Parcel in) {
            UsersSearchModel instance = new UsersSearchModel();
        ...
        public UsersSearchModel[] newArray(int size) {
            return (new UsersSearchModel[size]);
        }
